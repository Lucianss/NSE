...
function headerElem(){ // header() is already a function in PHP
 $header = "<div class='header'><a class='logo' href='".HOST."'><strong>Nevo</strong></a><form method='GET' action='".HOST."/search.php' class='searchForm'><input id='query' type='text' placeholder='Search a website' autocomplete='off' name='q' value=\"".$GLOBALS['displayQ']."\"/><button><svg viewBox='0 0 100 100' class='shape-search'><use xlink:href='#shape-search'></use></svg></button></form></div>";
 echo $header;
}
function footer(){
 $footer = "<div class='footer'><a href='".HOST."/about' style='text-decoration: none'><font color='grey'>About</font></a><a href='".HOST."/about/stats.php' style='text-decoration: none'><font color='grey'>Stats</font></a><a href='".HOST."/about/bot.php' style='text-decoration: none'><font color='grey'>Bot</font></a><div style='float:right;'><font color='grey'>&copy;</font> <a target='_blank' href='http://nevo.cf' style='text-decoration: none'><font color='grey'>Nevo</font></a></div></div>";
 $footer.='
